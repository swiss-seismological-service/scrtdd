...
public:
  ...
  struct Option : public Seiscomp::Core::BaseObject
  {
    Option(const char *cfgname,
        ...
        : cfgName(cfgname), cliGroup(cligroup), cliParam(cliparam),
...
protected:
  ...
  void addOption(std::vector<int> *var,
                 const char *cfgname,
                 const char *cligroup = nullptr,
                 const char *cliparam = nullptr,
                 const char *clidesc  = nullptr,
  ...
  void addOption(std::vector<double> *var,
                 const char *cfgname,
                 const char *cligroup = nullptr,
                 const char *cliparam = nullptr,
                 const char *clidesc  = nullptr,
  ...
  void addOption(std::vector<bool> *var,
                 const char *cfgname,
                 const char *cligroup = nullptr,
                 const char *cliparam = nullptr,
                 const char *clidesc  = nullptr,
  ...
  void addOption(std::vector<std::string> *var,
                 const char *cfgname,
                 const char *cligroup = nullptr,
                 const char *cliparam = nullptr,
                 const char *clidesc  = nullptr,
