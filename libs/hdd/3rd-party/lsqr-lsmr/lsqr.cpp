...
unsigned int lsqrBase::GetStoppingReason() const { return this->istop; }

std::string lsqrBase::GetStoppingReasonMessage() const
{
  std::string msg;
  switch (this->istop)
  {
  case 0: msg = "The exact solution is  x = 0"; break;
  case 1: msg = "A solution to Ax = b was found, given atol, btol"; break;
  case 2: msg = "A least-squares solution was found, given atol"; break;
  case 3: msg = "A damped least-squares solution was found, given atol"; break;
  case 4: msg = "Cond(Abar) seems to be too large, given conlim"; break;
  case 5: msg = "The iteration limit was reached"; break;
  default: msg = "Error. Unknown stopping reason"; break;
  }
  return msg;
}

unsigned int lsqrBase::GetNumberOfIterationsPerformed() const
{
  return this->itn;
}

double lsqrBase::GetFrobeniusNormEstimateOfAbar() const { return this->Anorm; }

double lsqrBase::GetConditionNumberEstimateOfAbar() const
{
  return this->Acond;
}

double lsqrBase::GetFinalEstimateOfNormRbar() const { return this->rnorm; }

double lsqrBase::GetFinalEstimateOfNormOfResiduals() const
{
  return this->Arnorm;
}

double lsqrBase::GetFinalEstimateOfNormOfX() const { return this->xnorm; }

void lsqrBase::SetStandardErrorEstimatesFlag(bool flag) { this->wantse = flag; }

void lsqrBase::SetEpsilon(double value) { this->eps = value; }

void lsqrBase::SetDamp(double value) { this->damp = value; }

void lsqrBase::SetToleranceA(double value) { this->atol = value; }

void lsqrBase::SetToleranceB(double value) { this->btol = value; }

void lsqrBase::SetMaximumNumberOfIterations(unsigned int value)
{
  this->itnlim = value;
}

void lsqrBase::SetUpperLimitOnConditional(double value)
{
  this->conlim = value;
}

void lsqrBase::SetStandardErrorEstimates(double *array) { this->se = array; }

void lsqrBase::SetOutputStream(std::ostream &os) { this->nout = &os; }

/**
 *  returns sqrt( a**2 + b**2 )
 *  with precautions to avoid overflow.
 */
double lsqrBase::D2Norm(double a, double b) const
{
...
/** Simplified for this use from the BLAS version. */
double lsqrBase::Dnrm2(unsigned int n, const double *x) const
{
 ...
 *
 */
void lsqrBase::Solve(unsigned int m, unsigned int n, const double *b, double *x)
{
  const double zero = 0.0;
